...
void draw() {
  ...
  for(float i = 0; i <= 50; i++){
    for(float j = 0; j <= 50; j++){
      beginShape();
      vertex((i * 5.0), (j * 5.0), 0.0, (i / 50.0), (j / 50.0));
      vertex(((i + 1.0) * 5.0), (j * 5.0), 0.0, ((i + 1.0) / 50.0), (j / 50.0));
      vertex(((i + 1.0) * 5.0), ((j + 1.0) * 5.0), 0.0, ((i + 1.0) / 50.0), ((j + 1.0) / 50.0));
      vertex((i * 5.0), ((j + 1.0) * 5.0), 0.0, (i / 50.0), ((j + 1.0) / 50.0));
      texture(sheep_texture);
      endShape();
    }
  }
